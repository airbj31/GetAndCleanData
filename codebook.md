...
tidyGalaxy is a first tidy data set which contains numerous observation and 5 columns. this is a huge data set over 600MB. so we can not print it into file for uploading. the dataset would be described in **data set : tidyGalaxy description** section.

**data set : tidyGalaxySummary** is a summarized data set from tidyGalaxy and output of instruction step 5 
