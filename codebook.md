...
the summarized data set was written in **[UCISamsungGalaxySIISummary.txt](https://github.com/airbj31/GetAndCleanData/blob/master/UCISamsungGalaxySIISummary.txt)**


## tidyGalaxy description
...
## tidyGalaxySummary (written in UCISamsungGalaxySIISummary.txt) description
